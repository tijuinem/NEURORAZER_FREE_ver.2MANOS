...
{
  int size_coche_extra_x = 25;
  int size_coche_extra_y = 50;
  ...
  {  
    ...
    if (y_aleatorio_coche_extra >= 7850)  {x_aleatorio_coche_extra = x_aleatorio_coche_extra - 300; }   
    if (y_aleatorio_coche_extra <= 200)   {x_aleatorio_coche_extra = x_aleatorio_coche_extra + 300; } 
...
{
  int size_bici_extra_x = 25;
  int size_bici_extra_y = 50;
  ...
  {  
    ...
    if (y_aleatorio_bici_extra >= 7850)  {x_aleatorio_bici_extra = x_aleatorio_bici_extra - 300; }   
    if (y_aleatorio_bici_extra <= 200)   {x_aleatorio_bici_extra = x_aleatorio_bici_extra + 300; }
...
{
  int size_camion_extra_x = 50;
  int size_camion_extra_y = 100;
  ...
  {  
    ...
    if (y_aleatorio_camion_extra >= 7850)  {x_aleatorio_camion_extra = x_aleatorio_camion_extra - 300; }   
    if (y_aleatorio_camion_extra <= 200)   {x_aleatorio_camion_extra = x_aleatorio_camion_extra + 300; }
