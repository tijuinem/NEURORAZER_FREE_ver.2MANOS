void PRESENTACION (void)
{
     ...
     textprintf(screen, font, 20,280, palette_color[10], "TECLA -F1/F2- Para Aumentar/Disminuir la Velocidad.");
     textprintf(screen, font, 20,290, palette_color[10], "TECLA -F4- para activar y aumentar la presencia de Coches.");
     textprintf(screen, font, 20,300, palette_color[10], "TECLA -F5- para activar y aumentar la presencia de Camiones.");
     ...
     textprintf(screen, font, 20,440, palette_color[9], "indicadas: autoria, no comercial, open source, y se permite editar codigo");
